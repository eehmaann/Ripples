    ...
    public function run()
    {
        $definers=[
			...
			['Broadcast Message', 'An energy that is continually sent out from the body to other people, who receive it subconsciously. It can 
				influence ability to form and keep relationships, as well as attract negativity, wrong people, etc.', 'no','', 'Mental'],
			['Despair Anchor', 'This was the energy of a thought that was stuck in your energy field. A negative statement perceived as true 
				that prompting your subconscious mind to verify or fulfill the &quot;truth&quot; of that thought.', 'no','', 'Mental'],
			['Images', 'The trapped energy of a “picture in the mind”. The subconscious will attempt to fulfill this image, and will direct 
				...
				on what the image is.', 'no','', 'Mental'],
			['Memory Field', 'The energy of memories stored in the energy field often in front of a person. They are present when memories are 
				traumatic and often recalled. That is why it makes if it difficult to move forward in life.', 'no','', 'Mental'],
			['No Will to Live', 'An energy that becomes trapped when life overwhelms us and we lose the desire to live.', 'no', '', 'Mental'],
			['Need For T3 Session', '', 'no','', 'Mental'],
			['Will to Die', 'A energy that develops from wishing for death, either as an escape or from self-abusive thoughts.', 'no','', 'Mental'],
			['Post-Hypnotic Suggestion', 'A negative statement became stuck in the subconscious mind during a time when people are in a 
				...
				accordingly.', 'no','', 'Offensive'],
			['Saboteur', 'These are weapons made of pure, invisible energy that are either self-inflicted or inflicted by another
				person. These are often a manifestation of someone\s negative feelings', 'no', '', 'Offensive'],
			['Entity', "Dark spirit(s) that exerts a negative influence on a person's  body and energy field.", 'no','', 'offensive'],
			['Curses', 'A very negative energy that has been deliberately placed into a person’s energy field by another
				person or entity with a more nefarious purpose than merely causing pain.', 'no','', 'Offensive'],
			...
			['Miasm', 'An inherited distortion of the energy field from suppressed disease that occurred during an ancestor’s life. 
				It influences the balance of body and mind.', 'no','', 'Post-Traumatic'],
			['Physical Trauma', 'An energy that occurs when the body is under extreme or sudden physical stress. Can also be from 
				emotional trauma or event or extreme prolonged stress.', 'no','', 'Post-Traumatic'],
			['Psychich Trauma', 'Similar to a trapped emotion but must be identified as a psychic trauma. When two or more 
				emotions are felt simultaneously, they become trapped into one sphere of energy.', 'yes','', 'Post-Traumatic'],
        	...
        	['Stress Hormones','Adrenalin and Cortisol are considered the “stress hormones” of the body. They can be 
        		produced in excess during difficult times, becoming toxic to the body.', 'no','', 'excesses'],
        	['Metabolic Waste', 'The by-products of all metabolic processes. If the organs of elimination are 
        		...
        		build up in the body.', 'no','', 'Excesses'],
        	['Free Radicals', '', 'no','', 'Excesses'],
        	['Six Pernicious Influences', '', 'no','', 'Excesses'],
        	['Environmental', 'Environmental Toxicity – toxins in the environment (outdoors, home, office, etc.) 
        		that are absorbed through the skin, lungs digestive system.', 'no', '','Chemicals'],
        	['Food Additives', 'Our modern processed food is filled with all sorts of chemicals that prolong 
        		shelf life, enhance flavor, etc. They interfere with metabolic processes and create abnormal cells.', 
        		'no', '', 'Chemicals'],
        	['Recreational Drugs', 'generally are very imbalancing to the energy field, and will often lead to weakness in
				the chakras as well as liver damage, kidney damage, etc. Drugs can open the body to invasion by entities.', 
				'no','', 'Chemical'],
			...
			['pH Imbalance','pH measures the acidity or alkalinity of the body. A pH of 7.3 -7.5 is healthy for the human 
				body. Most people have a too acid pH because of stress and diet.','no', '', 'Nutrition & Lifestyle'],
			['Physical Malnutrition','A group of conditions generally related to poor quality or insufficient quantity of 
				nutrient intake, absorption or utilization.','no','', 'Malnutrition'],
			['Spiritual Malnutrition','A condition caused by lack of spiritual “food”. It is a need for more quiet,
				unhurried time. Around the world, roughly 53% of the people are in a state of spiritual starvation, 32% eight 
				are in a state of spiritual malnutrition, only 15% of the people are spiritually well-nourished. Ways
				to increase spiritual nutrition include: prayer, mediation, inspiration readings, engaging in meaningful
				discussion, etc.','no','','Malnutrition'],
			...
			['Crown Chakra (Sahasrara)','The Crown chakra relates to higher consciousness, enlightenment, and inspiration. Located above the
				crown of the head, this Head Center chakra is related to the power of consciousness and corresponds with the universal 
				self and divine reality.','no', '', 'Chakras'],
			['Brow Chakra (The Third Eye Chakra, Ajna)','As the sixth of the body’s seven chakras, the Third Eye lies between the eyebrows and is the only chakra
				in the mental body. As such, it’s the center of command and corresponds with intuition, insight, and psychic awareness. 
				Furthermore, the Third Eye chakra affords us the ability to connect to elements beyond the five senses and controls the 
				individual self and power of inner perception.','no','','Chakras'],
			['Throat Chakra (Vishuddha)','Located in the throat area, this chakra is the energy center for creativity, speech, individual needs, and
				will. It’s known for its purity and relates to the power of communication by connecting with the ether, the respiratory system, and 
				higher intelligence. This is the second chakra in the Emotional Body.','no', '','Chakras'],
			['Heart Chakra (Anahata)','As one of two energy centers in the Emotional Body, the Heart chakra lies in the middle of the chest and
				is responsible for emotions and feelings like love, forgiveness, compassion, and self-esteem. Not surprisingly, the heart triggers 
				emotions of love and devotion and corresponds with the element air.','no','','Chakras'],
			['Solar Plexus Chakra (The Navel Chakra – Manipura)','As the last energy center in the physical body, the Navel chakra is considered the Solar Plexus and
				relates to the element of fire. The chakra, also known as the City of Gems, closely corresponds with the emotion anger and is responsible for 
				energies like desire, vitality, inner strength, and self-control. Lastly, the Navel chakra relates to the element of fire and governs the 
				digestive system and ego impulse.','no','','Chakras'],
			['Sacral Chakra (Svadhisthana)', 'Located above the genitals, the Sacral chakra is referred to as the Abode of Kundalini, or the center of
				energy that is yet to realize its potential. Because of its location, the Sacral chakra relates to the water element and controls emotions 
				that center around relationships, sexuality, and intimacy such as desire.', 'no', '', 'Chakra' ],
			['Root Chakra (Muladhara)','The Root chakra lies below the genitals and is the first of three physical body energy centers. As the
				center for survival, security, and primal energy, the Root chakra is connected to the Earth Element and relates to your natural survival 
				instincts and emotions, especially fear.','no','','Chakras'],
			...
			['Brachial Artery','','no','','Uppr Limb Vessels'],
			...
			['Epidermis','The outermost part of skin that forms a protection against teh external environment.  Consists of many layers
				of epithelial calls that replace themselves about every tow or two and a half months','no','', 'Skin'],
			['Dermis','The middle layer of the skin, where sweat glands and hair foolicles origniate.  It contains connective tissues 
				and blood vessels','no','', '', 'Skin'],
			['Hypodermis','The deepest layer of skin.  It attaches to bone or mecle and hosues fat deposits (adiose tissue)','no','','Skin'],
			...
			['6th rib','', 'no', '', 'True Rib'],
			['7th rib','', 'no', '', 'True Rib'],
			['8th rib','', 'no', '', 'False Rib'],
			['9th rib','', 'no', '', 'False Rib'],
			['10th rib','', 'no', '', 'False Rib'],
			['11th rib','', 'no', '', 'False Rib'],
			['12th rib','', 'no', '', 'False Rib'],
			...
			['T1','Connects to: Arms from the elbows down, hands wrists and fingers: esophagus and trachea, heart',
				'no', '', 'Thoracic Vertebrae'],
			['T2','Connects to: Hear, its valves and coronary arteries; lungs broncial tubes','no', '', 
				'Thoracic Vertebrae'],
			['T3','Connects to: Lungs, bronchial tubes, pleura, chest, breast, heart','no','','Thoracic Vertebrae'],
			['T4','Connects to: Gallbladder, common duct, heart, lungs, bronchial tubes','no','','Thoracic Vertebrae'],
			['T5','Connects to: Liver, solar plexus, circulation, heart, esophagus, stomach','no', '', 'Thoracic Vertebrae'],
			['T6','Connects to: Stomach, esophagus, peritoneum, liver, duodenum','no', '', 'Thoracic Vertebrae'],
			['T7','Connects to: Kidneys, appendix, testes, ovaries, uterus, adrenal cortex, spleen, pancreas, large intestine',
				'no', '', 'Thoracic Vertebrae'],
			['T8','Connects to: Spleen, stomach, liver, pancreas, gallbladder, adrenal cortex, small intestine, pyloric valve',
				'no', '', 'Thoracic Vertebrae'],
			['T9','Connects to: Adrenal cortex, pancreas, spleen, gallbladder, overies, uterus, small intestine',
				'no', '', 'Thoracic Vertebrae'],
			['T10','Connects to: Kidneys, appendix, testes, ovaries, uterus, adrenal cortex, splen, panreas, large intestine',
				'no', '', 'Thoracic Vertebrae'],
			['T11','Connects to: Kidneys, ureters, large intestine, urinary bladder, adrenal medulla, adrenial cortex, uterus, 
				ovaries, ileocecal valve','no', '', 'Thoracic Vertebrae'],
			['T12','Connects to: Small intestine, lymph circulation, large intestine, urinary bladder, uterus, kidneys, 
				ilececal valve', 'no', '', 'Thoracic Vertebrae'],
			...
			['L3','Connects to: Sex organs, uterus, bladder, knee, prostate, large intestine','no', '', 'Lumbar Vertebrae'],
			...
			['Sacrum','Connects to: Hip bones, buttocks, rectrum, sex organs, genitallia, urinary bladder, ureter, prostate',
				'no', '', 'Vertebral Column'],
			['Coccyx','Connects to: Rectum, anus','no', '', 'Vertebral Column'],

			['Ulna Bones','','no','','Upper Limbs'],
			['Radius Bones','','no','','Upper Limbs'],
			['Clavicle Bones','','no','','Uppper Limbs'],
			...
			['Tendons','Tendons connect muscles to bone, and are found on both ends of every muscle in the body',
				'no','','Connective Tissue'],
			['Ligaments','Ligaments connect bone to bone and are found throughout the body','no','', 'Connective Tissue'],
			['Fascia','Connective tissue that surrounds and protects all the other tissues of the body.','yes',
				'', 'Connective Tissue'],
